...
public class BinaryTreeForwardPreorderIterator<T, IBTN extends InternalBinaryTreeNode> implements Iterator<T> {
	...
	public BinaryTreeForwardPreorderIterator(BinaryTree<T, IBTN> binaryTree) {
		...
		this.mCurrentNode=(IBTN) this.mBinaryTree.dummy4.mParent.mLeftChild;
	}
